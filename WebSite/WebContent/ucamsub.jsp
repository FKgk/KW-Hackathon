	...
	<div id="wrap">
		...
		<%if(request.getParameter("sectionName")==null)
			...
			sectionName=request.getParameter("sectionName");
				PrintWriter script = response.getWriter();
				script.println("<script>");
				script.println("alert('과목을 선택해 주세요')");
				...
				script.println("</script>");
						...
						<form action="uploadAction.jsp" enctype="multipart/form-data" method="post">
							...
							<tr>
								<th>첨부파일:</th>
								<td><input action="uploadActiona1.jsp"
									enctype="multipart/form-data" method="post" type="file"
									name="file1"> <input action="uploadActiona1.jsp"
									enctype="multipart/form-data" method="post" type="file"
									name="file2"> <input action="uploadActiona1.jsp"
									method="post" type="file" name="file3"></td>
							</tr>
