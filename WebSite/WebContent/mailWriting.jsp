			...
			<div id="detail_list">
				...
				<tbody>
					<form action="sendMail.jsp" method="post" >
							...
							<td>
								<div class="column -lefs=">
									<div class="form-group" style="text-align: left;">
										...
										<input type="checkbox" autocomplete="off" name="To" value=<%=list.get(i).getUserEmail()%>><%=list.get(i).getUserName()%>
										</label>
										<%
											}
										%>
							...
							<td><input type="hidden" placeholder="보내는 사람  email" name="from" value="yw0501@naver.com"  /></td>
						...
						<tr>
							<th>내용:</th>
							 <td><textarea class="form-control" placeholder="글 입력하세요."   name="content" maxlength="2048" style="height: 500px;"></textarea></td>
						</tr>
